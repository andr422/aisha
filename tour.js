...
(function () {
  ...
  const VERSIONS = {
    final: 8,     // 8 — пробы обобщения записываются словами, есть «не получилось»
  ...
  const SCRIPTS = {
    final: [
      ...
      },
      {
        ...
        text: "Это доля самостоятельных ответов за сегодня — справа от названия цели. Три занятия подряд ≥80% — цель освоена. Нажмите и удерживайте название цели — покажет проценты прошлых занятий."
      },
      {
        sel: "#undoBtn",
