...
const CACHE_NAME = "aba-checklist-v106";
...
self.addEventListener("fetch", (event) => {
  ...
  // Страницы показа (папка demo/) кэш не трогает: они читают живые данные с
  // сервера, и старая копия из кэша испортила бы весь смысл. Приложения это
  // не касается — demo/ в APP_SHELL не входит.
